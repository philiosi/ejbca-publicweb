                    ...
                    <nav class="navbar navbar-expand-lg">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item pr-12"><a href="browser.jsp" class="nav-alink nav-alink-b">Create Browser Certificate</a></li>
                                <li class="nav-item pr-12"><a href="server.jsp" class="nav-alink">Create Certificate from CSR</a></li>
                                <li class="nav-item pr-12"><a href="keystore.jsp" class="nav-alink">Create Keystore</a></li>
